"""Regression test: parser output for ``KA-C-27-124630.md`` must match
``KA-C-27-124630.expected.json`` exactly.

Run with:
    python -m test.test_parser.test_kas_credit_note
...
def _deep_equal(a, b, path=""):
    """Diff-safe comparison: dicts/lists recursively, floats by tolerance."""
